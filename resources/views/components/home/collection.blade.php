  ...
  <div class="container">
    <div class="flex flex-wrap -mx-4">
      <div class="w-full px-4">
        <div class="text-center mx-auto mb-[60px] max-w-[510px]">
          <h2 class="font-bold text-2xl sm:text-3xl md:text-[40px] text-dark dark:text-gray-300 mb-4">
            Modèles de haute gammes
          </h2>
          <p class="text-base text-body-color">
            Visitez les meilleures collections de ma galerie vestimentaires.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-wrap -mx-4">
      @foreach ($items as $item)
        <x-collection-item :title="$item['title']"
                          :categories="$item['category']"
                          :image="$item['image']"
                          :github="$item['github']"></x-collection-item>
      @endforeach
    </div>
  </div>
</section>
