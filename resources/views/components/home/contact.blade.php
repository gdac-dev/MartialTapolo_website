        ...
        <div class="max-w-[570px] mb-12 lg:mb-0">
          ...
          <div class="flex mb-8 max-w-[370px] w-full">
            ...
            <div class="w-full">
              ...
              <p class="text-base text-body-color dark:text-gray-300">gilbert.alegue@jgmeconsulting.com</p>
            </div>
          </div>
        </div>
      </div>
              ...
              submitForm(event) {
                ...
                this.errors = {};
                  ...
                  .then(result => {
                    ...
                    this.successMessage = 'Merci pour votre demande de contact. Je vous répondrai dans les plus brefs délais.';
                  })
